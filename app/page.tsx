      ...
      <section className="relative overflow-hidden max-w-6xl mx-auto px-8 py-28 text-center">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-lg md:text-xl mt-8 max-w-3xl mx-auto leading-8">
            Practice real interview rounds, receive instant AI feedback, improve
            confidence, and get job-ready faster.
          </p>

          <div className="mt-12 flex justify-center gap-5 flex-wrap">
            <Link href="/select-role">
              <button className="bg-blue-500 hover:bg-blue-600 px-8 py-4 rounded-2xl font-semibold text-lg transition shadow-lg flex items-center gap-3">
